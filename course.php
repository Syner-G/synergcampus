            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="detail.php">
                        <img class="img-fluid" src="img/ggg.png" alt="">
                        <div class="courses-text">
                            <h4 class="text-center text-white px-3">Contact Center Service NC II</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <p class="m-0">Designed by <a class="text-white" href="">GHIANNE AMANTE</a>
                    </p>
                </div>
            </div>
        </div>
